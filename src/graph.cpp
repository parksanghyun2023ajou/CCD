...
Qcircuit::Edge::Edge() { }
Qcircuit::Edge::Edge(Node* source, Node* target, double weight) 
{
    id = global_id++;
    this->weight = weight;
...
int Qcircuit::Edge::getid() const{ return id; }
int Qcircuit::Edge::getglobalid() const{ return global_id; }
double Qcircuit::Edge::getweight() const{ return weight; }
int Qcircuit::Edge::getsourceid() const{ return source->getid(); }
int Qcircuit::Edge::gettargetid() const{ return target->getid(); }
void Qcircuit::Edge::setweight(double weight) { this->weight = weight; }
...
bool Qcircuit::Graph::addedge(int source, int target, double weight)
{
